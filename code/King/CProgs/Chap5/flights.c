/* flights.c
 *
 * Solution to Programming Project 8 (Chapter 5)
 *
...
int main(void)
{
  ...
  /* Display departure and arrival times. Code from Programming Project 2
   * could be used here, but arrival time would need to be stored in a variable.
   */
  switch (closest) {
    case 480:
